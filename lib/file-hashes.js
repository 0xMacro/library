...
module.exports = function renderFileHashesTemplate(content) {
  ...
  return `
    <table class="mt-8 table-fixed w-full divide-y divide-gray-300 dark:divide-gray-600 border-t border-b sm:border-r sm:border-l dark:border-gray-600">
      <thead>
        <tr>
          <th
            scope="col"
      ...
      <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
        ${fileHashes.map(({ file, hash }) =>
            ...
            <tr>
              ...
              <td class="w-1/2 p-4 text-gray-500 dark:text-gray-100 font-ui text-left break-words break-all">
                ${hash}
              </td>
            </tr>
            `
